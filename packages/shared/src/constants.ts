...
export const CARD_DEFS: CardDef[] = [
  ...
  { id: 'reinforce', name: 'Reinforce', cost: 2, type: 'cast', category: 'fortification', rarity: 'common',
    description: 'Gain 12 Block.', effects: [{ type: 'block', value: 12, target: 'self' }] },
  { id: 'barrage', name: 'Barrage', cost: 2, type: 'cast', category: 'armament', rarity: 'common',
    description: 'Deal 4 damage to all enemies.', effects: [{ type: 'damage', value: 4, target: 'all' }] },
  ...
  { id: 'precision', name: 'Precision', cost: 1, type: 'cast', category: 'armament', rarity: 'uncommon',
    description: 'Deal 15 damage to an enemy.', effects: [{ type: 'damage', value: 15, target: 'single' }] },
  ...
  { id: 'cataclysm', name: 'Cataclysm', cost: 4, type: 'cast', category: 'armament', rarity: 'legendary',
    description: 'Deal 30 damage to all enemies. Take 10 Gate damage.', effects: [{ type: 'damage', value: 30, target: 'all' }] },
  { id: 'keeps_resolve', name: "Keep's Resolve", cost: 0, type: 'cast', category: 'edict', rarity: 'legendary',
    description: 'Gain 3 Resolve. Draw 3 cards.', effects: [{ type: 'resolve', value: 3 }, { type: 'draw', value: 3 }] },
