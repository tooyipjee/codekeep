...
export const CARD_DEFS: CardDef[] = [
  ...
  // ── Synergy / Conditional Cards ──
  { id: 'emplacement_surge', name: 'Emplacement Surge', cost: 1, type: 'cast', category: 'edict', rarity: 'uncommon',
    description: 'Each emplacement triggers its effect an extra time.',
    effects: [{ type: 'trigger_emplacements', value: 1 }] },
  { id: 'fuel_the_fire', name: 'Fuel the Fire', cost: 1, type: 'cast', category: 'armament', rarity: 'uncommon',
    description: 'Deal 2 damage per Burn stack on all enemies.',
    effects: [{ type: 'damage_per_burn', value: 2, target: 'all' }] },
  { id: 'fortified_assault', name: 'Fortified Assault', cost: 2, type: 'cast', category: 'armament', rarity: 'rare',
    description: 'Deal damage equal to your current Block.',
    effects: [{ type: 'damage_equal_block', value: 1, target: 'single' }] },
  { id: 'pale_harvest', name: 'Pale Harvest', cost: 0, type: 'cast', category: 'edict', rarity: 'uncommon',
    description: 'Draw 1 card per enemy killed this combat. Exhaust.',
    effects: [{ type: 'draw_per_kills', value: 1 }, { type: 'exhaust_self', value: 1 }] },
  { id: 'wall_breaker', name: 'Wall Breaker', cost: 2, type: 'cast', category: 'armament', rarity: 'uncommon',
    description: 'Deal 8 damage. If target is Vulnerable, deal 16 instead.',
    effects: [{ type: 'damage_if_vulnerable', value: 8, target: 'single' }] },
  { id: 'chain_lightning', name: 'Chain Lightning', cost: 2, type: 'cast', category: 'armament', rarity: 'rare',
    description: 'Deal 5 damage to all enemies. For each killed, deal 5 more to all.',
    effects: [{ type: 'damage', value: 5, target: 'all' }, { type: 'damage_per_kill_this_action', value: 5, target: 'all' }] },
  ...
  { id: 'combustion', name: 'Combustion', cost: 2, type: 'cast', category: 'armament', rarity: 'rare',
    description: 'Apply 4 Burn to all enemies. If any already has Burn, apply 6 instead.',
    effects: [{ type: 'burn_if_burning', value: 4, target: 'all' }] },
  { id: 'bulwark_strike', name: 'Bulwark Strike', cost: 1, type: 'cast', category: 'armament', rarity: 'uncommon',
    description: 'Deal 4 damage + 1 per point of Block you have (max +10).',
    effects: [{ type: 'damage_plus_block', value: 4, target: 'single' }] },
  { id: 'pale_echo', name: 'Pale Echo', cost: 2, type: 'cast', category: 'wild', rarity: 'rare',
    description: 'Play the last card you played again (copy its effects).',
    effects: [{ type: 'replay_last', value: 1 }] },
  { id: 'column_collapse', name: 'Column Collapse', cost: 2, type: 'cast', category: 'armament', rarity: 'uncommon',
    description: 'Deal 12 damage to all enemies in target column. If column has an emplacement, deal 18 instead.',
    effects: [{ type: 'damage_if_emplaced', value: 12, target: 'column' }] },
  { id: 'overcharge', name: 'Overcharge', cost: 0, type: 'cast', category: 'edict', rarity: 'uncommon',
    description: 'Gain 2 Resolve. Exhaust.',
    effects: [{ type: 'resolve', value: 2 }, { type: 'exhaust_self', value: 1 }] },
  { id: 'desperate_strike', name: 'Desperate Strike', cost: 1, type: 'cast', category: 'armament', rarity: 'common',
    description: 'Deal 5 damage. If Gate HP < 50%, deal 10 instead.',
    effects: [{ type: 'damage_if_low_hp', value: 5, target: 'single' }] },
  { id: 'fortress_keeper', name: 'Fortress Keeper', cost: 3, type: 'emplace', category: 'fortification', rarity: 'rare',
    description: 'Cast: Gain 15 Block, draw 1. Emplace: 12 HP, +4 Block/turn, adjacent emplacements +2 HP.',
    effects: [{ type: 'block', value: 15, target: 'self' }, { type: 'draw', value: 1 }],
    emplaceCost: 3, emplaceHp: 12, emplaceEffects: [{ type: 'block', value: 4, target: 'self' }] },
  { id: 'resonance', name: 'Resonance', cost: 1, type: 'cast', category: 'armament', rarity: 'uncommon',
    description: 'Deal 3 damage to all enemies for each emplacement you control.',
    effects: [{ type: 'damage_per_emplace', value: 3, target: 'all' }] },
  { id: 'scavenge', name: 'Scavenge', cost: 0, type: 'cast', category: 'edict', rarity: 'common',
    description: 'Draw cards equal to number of empty potion slots.',
    effects: [{ type: 'draw_per_empty_potions', value: 1 }] },
  { id: 'final_stand', name: 'Final Stand', cost: 3, type: 'cast', category: 'wild', rarity: 'legendary',
    description: 'Deal 10 damage to all. Gain 10 Block. Draw 3. Exhaust.',
    effects: [{ type: 'damage', value: 10, target: 'all' }, { type: 'block', value: 10, target: 'self' }, { type: 'draw', value: 3 }, { type: 'exhaust_self', value: 1 }] },

  // ── Curse ──
  { id: 'pale_curse', name: 'Pale Curse', cost: 99, type: 'cast', category: 'wild', rarity: 'common',
    description: 'An echo of the Pale. Unplayable. Clogs your hand.',
    effects: [] },
];
