...
export const LORE_ENTRIES: LoreEntry[] = [
  ...
  { id: 'lore_contradiction', title: 'Recovered Fragment — Origin Unknown', text: 'The Pale was not created. It was always there. The Architect did not build the first Keep — they found it, already standing, already defended, already scarred. The records say the Architect made the Pale. But this fragment predates the Architect\'s birth by three hundred years. It reads: \'The Pale is watching.\'', unlockCondition: { type: 'ascension', value: 12 } },
  { id: 'lore_cards_are_memories', title: 'On the Nature of Patterns', text: 'Sable explained it to me once: a Strike is not a weapon. It\'s the memory of protection so fierce it cuts. A Guard is not a shield. It\'s the refusal to break, crystallized into form. Every card in your deck is someone\'s last act of defiance against forgetting. When you play a Cataclysm, you\'re spending someone\'s world. Remember that.', unlockCondition: { type: 'runs', value: 20 } },
];
